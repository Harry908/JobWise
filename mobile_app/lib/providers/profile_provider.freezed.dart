...
class _$ProfileStateImpl extends _ProfileState {
  ...
  @override
  String toString() {
    return 'ProfileState(profile: $profile, isLoading: $isLoading, isSaving: $isSaving, errorMessage: $errorMessage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, profile, isLoading, isSaving, errorMessage);
